...
def show_image(state,rat_action,dog_action,dog_size,rat_size,length,N_ACT,PI):
    ...
    if state == 0: #down
        ...
        #Positions
        position_dog = [int(length-dog_size), length, dog_down, dog_up]
        position_rat = [int(length-rat_size), length, rat_down, rat_up]
        ...
        #Positions
        position_dog = [0, dog_size, dog_down, dog_up]
        position_rat = [0, rat_size, rat_down, rat_up]
        ...
        #Positions
        position_dog = [dog_down, dog_up, 0, dog_size]
        position_rat = [rat_down, rat_up, 0, rat_size] 
        ...
        #Positions
        position_dog = [dog_down, dog_up, int(length-dog_size), length]
        position_rat = [rat_down, rat_up, int(length-rat_size), length]
    
    print(position_dog)
    print(position_rat)

    catch = caught (position_dog, position_rat)
...
#    plt.clf()
    ...
    return user_input,result, catch


def caught (position_dog, position_rat):
    
    if position_dog[0] <= position_rat[0] and position_dog[1] >= position_rat[1] and position_dog[2] <= position_rat[2] and position_dog[3] >= position_rat[3]:
        print("CATCH !")
        return True
    else :
        return False
