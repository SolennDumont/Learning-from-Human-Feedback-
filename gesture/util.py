...
def gesture_recognition():
        ...
        while True :
                ...
                if className == "live long" or className == "stop" : # Good feedback : main ouverte
...
#    plt.draw()
    ...
    print('input(good (0): main ouverte, bad (1): peace, no_feedback (2): fist, next state (3): thumbs up):')
    plt.show()
