...
def show_image(state,rat_action,dog_action,dog_size,rat_size,length,N_ACT,PI):
    ...
    img_dog = cv2.resize(img_dog, (dog_size, dog_size)) 
    ...
    # if text == 'good': #Catch
    #     user_input= 0 #Good feed back
    # elif text == 'bad':
    #     user_input = 1 #Bad feed back
    # elif text == 'next':
    #     user_input = 3 #Bad feed back (too far)
    # elif text == 'neutral':
    #     user_input = 2
    # else :
    #     user_input = 2 #no feedback
